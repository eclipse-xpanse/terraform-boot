...
@SpringBootTest(classes = {TerraformInstaller.class, TerraformVersionsHelper.class,
        TerraformVersionsCache.class, TerraformVersionsFetcher.class, SystemCmd.class},
        properties = {"support.default.terraform.versions.only=false"})
class TerraformInstallerTest {

    @Value("${terraform.versions:1.6.0,1.7.0,1.8.0,1.9.0}")
